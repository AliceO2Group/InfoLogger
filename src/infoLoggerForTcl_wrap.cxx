...
#define SWIG_init    Infologgerfortcl_Init
#define SWIG_name    "infologgerfortcl"
#define SWIG_prefix  ""
...
#endif
SWIGINTERN int
_wrap_new_InfoLogger(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  InfoLogger *result = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,":new_InfoLogger ") == TCL_ERROR) SWIG_fail;
  {
    try {
  ...
  Tcl_SetObjResult(interp, SWIG_NewInstanceObj( SWIG_as_voidptr(result), SWIGTYPE_p_InfoLogger,0));
  return TCL_OK;
fail:
  return TCL_ERROR;
}
...
SWIGINTERN int
_wrap_delete_InfoLogger(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  InfoLogger *arg1 = (InfoLogger *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:delete_InfoLogger self ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_InfoLogger, SWIG_POINTER_DISOWN |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_InfoLogger" "', argument " "1"" of type '" "InfoLogger *""'"); 
  }
...
SWIGINTERN int
_wrap_InfoLogger_logInfo(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  InfoLogger *arg1 = (InfoLogger *) 0 ;
  std::string *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:InfoLogger_logInfo self message ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_InfoLogger, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  {
    try {
      (arg1)->logInfo((std::string const &)*arg2);
    } catch (const std::string& e) {
      SWIG_exception(SWIG_RuntimeError, e.c_str());
    }
  }
...
SWIGINTERN int
_wrap_InfoLogger_logError(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  InfoLogger *arg1 = (InfoLogger *) 0 ;
  std::string *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:InfoLogger_logError self message ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_ConvertPtr(objv[1], &argp1,SWIGTYPE_p_InfoLogger, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
  ...
  {
    try {
      (arg1)->logError((std::string const &)*arg2);
    } catch (const std::string& e) {
      SWIG_exception(SWIG_RuntimeError, e.c_str());
    }
  }
...
SWIGINTERN void swig_delete_InfoLogger(void *obj) {
InfoLogger *arg1 = (InfoLogger *) obj;
delete arg1;
}
static swig_method swig_InfoLogger_methods[] = {
    {"logInfo", _wrap_InfoLogger_logInfo}, 
    {"logError", _wrap_InfoLogger_logError}, 
    {0,0}
};
static swig_attribute swig_InfoLogger_attributes[] = {
    {0,0,0}
};
static swig_class *swig_InfoLogger_bases[] = {0};
static const char * swig_InfoLogger_base_names[] = {0};
static swig_class _wrap_class_InfoLogger = { "InfoLogger", &SWIGTYPE_p_InfoLogger,_wrap_new_InfoLogger, swig_delete_InfoLogger, swig_InfoLogger_methods, swig_InfoLogger_attributes, swig_InfoLogger_bases,swig_InfoLogger_base_names, &swig_module };

static swig_command_info swig_commands[] = {
    { SWIG_prefix "new_InfoLogger", (swig_wrapper_func) _wrap_new_InfoLogger, NULL},
    { SWIG_prefix "delete_InfoLogger", (swig_wrapper_func) _wrap_delete_InfoLogger, NULL},
    { SWIG_prefix "InfoLogger_logInfo", (swig_wrapper_func) _wrap_InfoLogger_logInfo, NULL},
    { SWIG_prefix "InfoLogger_logError", (swig_wrapper_func) _wrap_InfoLogger_logError, NULL},
    { SWIG_prefix "InfoLogger", (swig_wrapper_func) SWIG_ObjectConstructor, (ClientData)&_wrap_class_InfoLogger},
    {0, 0, 0}
};
...
static swig_type_info _swigt__p_InfoLogger = {"_p_InfoLogger", "InfoLogger *", 0, 0, (void*)&_wrap_class_InfoLogger, 0};
...
SWIGEXPORT int Infologgerfortcl_SafeInit(Tcl_Interp *interp) {
