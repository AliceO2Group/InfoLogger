...
#define LOGINFO(level) InfoLogger::InfoLoggerMessageOption {InfoLogger::Severity::Info,level,-1,__FILE__,__LINE__}
// this one sets an error message with provided log level and error code
#define LOGERROR(level,errno) InfoLogger::InfoLoggerMessageOption {InfoLogger::Severity::Error,level,errno,__FILE__,__LINE__}
